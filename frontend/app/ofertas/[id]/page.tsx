          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="font-semibold">{oferta.tipo_contrato}</p>
              </div>
            </div>
            ...
            {oferta.salario_min && oferta.salario_max && (
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="font-semibold">${oferta.salario_min} - ${oferta.salario_max}</p>
                </div>
              </div>
            )}
            ...
            {oferta.fecha_cierre && (
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="font-semibold">{new Date(oferta.fecha_cierre).toLocaleDateString()}</p>
                </div>
              </div>
            )}
          </div>
