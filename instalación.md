🚀 Guía de Configuración: Stack Fullstack (Laravel + Next.js)
...
Es necesario instalar las siguientes herramientas antes de comenzar:
...
Para optimizar el flujo de trabajo, se recomienda instalar las siguientes extensiones:
...
🐳 5. Despliegue con DockerUna vez configurados los archivos docker-compose.yml y los Dockerfile correspondientes:
...
Asegúrate de ejecutar las migraciones dentro del contenedor.Verifica que los parámetros del .env coincidan con los definidos en el servicio mysql del docker-compose.yml.